...
@Configuration
@EnableJpaRepositories(basePackages = { "com.cotecoeur"})
...
public class H2TestProfileJPAConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUsername("CoteCoeur");
        dataSource.setPassword("CoteCoeur");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.cotecoeur" });
